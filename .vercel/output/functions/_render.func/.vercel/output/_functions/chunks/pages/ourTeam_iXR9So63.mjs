...
In 1991 I purchased Phillips-Hansen Land Title Company from Albert and Lucille Hansen. Al said he
                ...
                appreciate what I have done for the past 37 years.</p> </div> </div> </div> <div class="bioWrapper"> <div class="nameb"> <div class="name"> <h3>Haylee Tolman</h3> </div> <div class="title">
...
I cherish connecting with our customers. Beyond work, I indulge in outdoor adventures - 
              from water sports to sunset strolls, cherishing moments with loved ones.</p> </div> </div> <div class="image"> ${renderComponent($$result2, "Image", $$Image, { "src": haylee, "alt": "Haylee Tolman" })} </div> </div> <div class="bioWrapper"> <div class="image"> ${renderComponent($$result2, "Image", $$Image, { "src": katie, "alt": "Katie Hoogs" })} </div> <div class="nameb"> <div class="name"> <h3>Katie Hoogs</h3> </div> <div class="title">
